...
begin
  ...
  begin
    if  MessageBox(Handle,' „‘Œ’«  ÃœÌœ ‘Œ’ –ŒÌ—Â ‘Êœø ','?',MB_YESNO or MB_RIGHT or MB_RTLREADING or MB_ICONQUESTION)=idyes then
    begin
      update_shakhs;
      MessageBox(Handle,'„‘Œ’«  ÃœÌœ Œ—Ìœ«—°–ŒÌ—Â ‘œ',' ÊÃÂ!',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONINFORMATION);
      close;
    end;
  end;
end;
