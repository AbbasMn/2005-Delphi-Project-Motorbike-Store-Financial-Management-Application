...
begin
  ...
  ' ';
   ...
   MessageBox(Handle,'„‘Œ’«  ÃœÌœ „Ê Ê— ”Ìò·  –ŒÌ—Â ‘œ',' ÊÃÂ!',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONINFORMATION);
end;
...
begin
  ...
  begin
    if  MessageBox(Handle,'„‘Œ’«  ÃœÌœ „Ê Ê— –ŒÌ—Â ‘Êœø ','?',MB_YESNO or MB_RIGHT or MB_RTLREADING or MB_ICONQUESTION)=idyes then
    begin
      if l_type.Caption='forosh' then
        update_motor
      else
