...
begin
  ...
  begin
   if L_tarikhe_emroz.Caption < DBText20.Caption then
    MessageBox(Handle,' «—ÌŒ Å—œ«Œ  ﬁ”ÿ ‰„Ì  Ê«‰œ “Êœ — «“  «—ÌŒ ›—Ê‘ »«‘œ !!','!Œÿ«',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONEXCLAMATION)
   else
    begin
           if StrToFloat(e_mablagh_pardakhti.Text) >StrToFloat(DBText25.Caption) then
            MessageBox(Handle,'„»·€ Å—œ«Œ Ì ‰»«Ìœ «“ „»·€ »«ﬁÌ„«‰œÂ ò· »Ì‘ — »«‘œ','!Œÿ«',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONEXCLAMATION)
           else
           begin
