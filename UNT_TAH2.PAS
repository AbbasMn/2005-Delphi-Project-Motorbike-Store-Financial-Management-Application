...
begin
  ...
  MessageBox(Handle,'„‘Œ’«  ÃœÌœ ò«—  ”ÊŒ  „Ê Ê— ”Ìò· °–ŒÌ—Â ‘œ',' ÊÃÂ!',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONINFORMATION);  
end;
...
begin
  ...
  begin
    s:=' ò«—  ”ÊŒ  „Ê Ê— ”Ìò·  »Â ‘„«—Â ' + DataM_tahvil_joz.ADOQ_carte_sokhtcarte_sokht_shomare.AsString+' œ—  «—ÌŒ '+DataM_tahvil_joz.ADOQ_carte_sokhtcarte_sokht_tarikh.AsString+
    ' »Â '+DataM_tahvil_joz.ADOQ_carte_sokhtcarte_sokht_tahvil_girande.AsString+'  ÕÊÌ· œ«œÂ ‘œÂ «”  ';
...
begin
  ...
  MessageBox(Handle,'„‘Œ’«  ò«—  ”ÊŒ  „Ê Ê— ”Ìò·  –ŒÌ—Â ‘œ',' ÊÃÂ!',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONINFORMATION);  
end;
function Tfrm_tahvil_karte_sokht.check:boolean;
begin
  check:=true;
  if (e_sokht_tahvilgir.Text='') or (e_sokht_tahvilgir.Text=' ÕÊÌ· œ«œÂ ‰‘œÂ') then
  begin
    MessageBox(Handle,'‰«„ Ê ‰«„ Œ«‰Ê«œêÌ  ÕÊÌ· êÌ—‰œÂ ”‰œ »«Ìœ Ê«—œ ‘Êœ','!Œÿ«',MB_OK or MB_RIGHT or MB_RTLREADING or MB_ICONEXCLAMATION);
    check:=false;
  ...
  begin
    MessageBox(Handle,'‘„«—Â ”‰œ »«Ìœ Ê«—œ ‘Êœ','!Œÿ«',MB_OK or MB_RIGHT or MB_ICONEXCLAMATION);
    check:=false;
    e_sokht_tahvilgir.SetFocus;
    Exit;
  end;
  ...
  begin
    MessageBox(Handle,'—Ê“  ÕÊÌ· ”‰œ »«Ìœ Ê«—œ ‘Êœ','!Œÿ«',MB_OK or MB_RIGHT or MB_ICONEXCLAMATION);
    check:=false;
  ...
  begin
    MessageBox(Handle,'„«Â  ÕÊÌ· ”‰œ »«Ìœ Ê«—œ ‘Êœ','!Œÿ«',MB_OK or MB_RIGHT or MB_ICONEXCLAMATION);
    check:=false;
  ...
  begin
    MessageBox(Handle,'”«·  ÕÊÌ· ”‰œ »«Ìœ Ê«—œ ‘Êœ','!Œÿ«',MB_OK or MB_RIGHT or MB_ICONEXCLAMATION);
    check:=false;
...
begin
  ...
  begin
    ...
    if  MessageBox(Handle,'„‘Œ’«  ÃœÌœ ò«—  ”ÊŒ  –ŒÌ—Â ‘Êœø ','?',MB_YESNO or MB_RIGHT or MB_RTLREADING or MB_ICONQUESTION)=idyes then
    begin
      update_karte_sokht;
      close;
    end;
